...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // S156: added star_sign/generation/chinese_zodiac — display-only optional
    // badges, same as the match card. Not used in householdCalcCompat().
    ...
    const members = (memberRows || []).map(function(m) {
      ...
      return {
        ...
        // S156: optional profile badges — display-only, never a compat factor.
